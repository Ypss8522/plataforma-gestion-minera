    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.login = function (email, password) {
            return __awaiter(this, void 0, void 0, function () {
                var usuario, passwordValido, payload;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, bcrypt.compare(password, usuario.passwordHash)];
                        case 2:
                        ...
                        case 3: return [2 /*return*/, (_a.accessToken = _b.sent(),
                                _a.usuario = { id: usuario.id, email: usuario.email, rol: usuario.rol },
                                _a)];
                    }
                });
            });
