...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
         ...
         */
        PrismaService_1.prototype.withRlsContext = function (params, fn) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.$transaction(function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tx.$executeRawUnsafe("SET LOCAL app.rol = '".concat(params.rol, "'"))];
                                    case 1:
                                        _a.sent();
                                        if (!params.trabajadorId) return [3 /*break*/, 3];
                                        return [4 /*yield*/, tx.$executeRawUnsafe("SET LOCAL app.trabajador_id = '".concat(params.trabajadorId, "'"))];
                                    case 2:
                                        _a.sent();
                                        _a.label = 3;
                                    case 3:
                                        if (!params.empresaId) return [3 /*break*/, 5];
                                        return [4 /*yield*/, tx.$executeRawUnsafe("SET LOCAL app.empresa_id = '".concat(params.empresaId, "'"))];
                                    case 4:
                                        _a.sent();
                                        _a.label = 5;
                                    case 5: return [2 /*return*/, fn(tx)];
                                }
                            });
                        }); })];
                });
