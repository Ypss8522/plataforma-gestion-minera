        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    app.enableCors({
                        origin: (_b = (_a = process.env.CORS_ORIGINS) === null || _a === void 0 ? void 0 : _a.split(',')) !== null && _b !== void 0 ? _b : ['http://localhost:3001'],
                        credentials: true,
                    });
                    ...
                    return [4 /*yield*/, app.listen((_c = process.env.PORT) !== null && _c !== void 0 ? _c : 3000)];
                case 2:
                    _d.sent();
                    return [2 /*return*/];
            }
