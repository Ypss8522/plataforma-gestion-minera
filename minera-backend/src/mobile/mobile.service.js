...
var MobileService = function () {
    ...
    var MobileService = _classThis = /** @class */ (function () {
         ...
         */
        MobileService_1.prototype.obtenerMiEstado = function (trabajadorId) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.withRlsContext({ rol: 'TRABAJADOR', trabajadorId: trabajadorId }, function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            var trabajador, contextos, documentos;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tx.trabajador.findUnique({
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, tx.trabajadorEstadoContexto.findMany({
                                                where: { trabajadorId: trabajadorId },
                                                include: { minera: true, cargo: true },
                                            })];
                                    case 2:
                                        contextos = _a.sent();
                                        return [4 /*yield*/, tx.documento.findMany({
                                                where: { trabajadorId: trabajadorId },
                                    ...
                                    case 3:
                                        ...
                                        return [2 /*return*/, {
                                                ...
                                                contextos: contextos.map(function (c) { return ({
                                                ...
                                                documentos: documentos.map(function (d) { return ({
        ...
        MobileService_1.prototype.obtenerMisNotificaciones = function (trabajadorId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, { trabajadorId: trabajadorId, notificaciones: [] }];
                });
            });
        };
