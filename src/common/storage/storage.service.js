...
var StorageService = function () {
    ...
    var StorageService = _classThis = /** @class */ (function () {
        function StorageService_1(configService) {
            ...
            this.bucket = this.configService.get('STORAGE_BUCKET', 'minera-documentos-sensibles');
            this.urlExpirySeconds = parseInt(this.configService.get('STORAGE_SIGNED_URL_EXPIRY_SECONDS', '300'), 10);
         ...
         */
        StorageService_1.prototype.subirArchivoBase64 = function (base64Data, mimeType, trabajadorId, documentoTipoId) {
            return __awaiter(this, void 0, void 0, function () {
                var buffer, extension, fileKey, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            fileKey = "documentos/".concat(trabajadorId, "/").concat(documentoTipoId, "/").concat((0, uuid_1.v4)(), ".").concat(extension);
                            return [4 /*yield*/, this.s3Client.send(new client_s3_1.PutObjectCommand({
                                    Bucket: this.bucket,
                                    Key: fileKey,
                                    Body: buffer,
                        ...
                        case 2:
                            error_1 = _a.sent();
                            this.logger.error('Error al subir archivo a R2', error_1);
         ...
         */
        StorageService_1.prototype.obtenerUrlFirmadaLectura = function (fileKey) {
            return __awaiter(this, void 0, void 0, function () {
                var command, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_2 = _a.sent();
                            this.logger.error('Error al generar URL firmada', error_2);
                            throw new common_1.InternalServerErrorException({
